...
public class Customer implements Comparable<Customer> {
  ...
  /**
   * Assume that we sort Customers based on their zip code.
   */
  public int compareTo(Customer object) {

    Customer otherCustomer = object;

    if (this.zipCode < otherCustomer.zipCode) {
      return -1;
    } else if (this.zipCode == otherCustomer.zipCode) {
      return 0;
    } else {
      return 1;
    }
