...
public class AccountFacory {
	...
	/**
	 * This is a factory method that creates bundles of objects. Just let us know
	 * which account bundle type you like to have and do not care about the details
	 * how we create accounts.
	 * 
	 * Note: In abstract factory pattern clients may not know that they are creating
	 * bundles.
	 * 
	 * @param type
	 *            type of the bank account bundles to create
	...
	/**
	 * This is a factory method that creates the objects. Just let us know which
	 * account you like to have and do not care about the details how we create
	 * accounts.
	 * 
	 * @param type
	 *            type of the bank account to create
	 * @return a bank account
	 */
